//Shared On Load//
    $(function() {
        ...
        $('#myNavbar').html(
            ...
            '</a>' +
            '<a href="index.html#top" class="w3-bar-item w3-button">HOME</a>' +
            ...
            '<a href="TravelChecklist.html" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-plane"></i> TRAVEL CHECKLIST</a>' +
            '<a href="PoliceAPI.html" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-balance-scale"></i> POLICE API TEST</a>' +
            '<a href="Miscellaneous.html" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-ellipsis-h"></i> MISCELLANEOUS</a>' +
            '<a href="https://github.com/chas90uk/MySoundboard/raw/master/platforms/android/app/build/outputs/apk/debug/app-debug.apk" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-question-circle"></i> My Android App</a>' +
        ...
        $('#navDemo').html(
            ...
            '<a href="TravelChecklist.html" class="w3-bar-item w3-button" onclick="toggleFunction()">TRAVEL CHECKLIST</a>' +
            ...
            '<a href="https://github.com/chas90uk/MySoundboard/raw/master/platforms/android/app/build/outputs/apk/debug/app-debug.apk" class="w3-bar-item w3-button" onclick="toggleFunction()">My Android App</a>' +
