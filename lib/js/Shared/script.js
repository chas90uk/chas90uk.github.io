//Shared On Load//
    $(function() {
        ...
        $('#myNavbar').html(
            ...
            '<a href="https://github.com/chas90uk/OfflineDifferenceTool" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-file-code-o"></i> OFFLINE DIFF TOOL</a>' +
        ...
        $('#navDemo').html(
            ...
            '<a href="https://github.com/chas90uk/OfflineDifferenceTool" class="w3-bar-item w3-button" onclick="toggleFunction()">OFFLINE DIFF TOOL</a>' +
