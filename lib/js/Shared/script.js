//Shared On Load//
    $(function() {
        ...
        $('#myNavbar').html(
            ...
            '<a href="https://github.com/chas90uk/HelloWorldTEMP/raw/master/app-debug.apk" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-question-circle"></i>My Android App</a>' +
